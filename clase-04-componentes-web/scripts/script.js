Vue.component("tabla-felinos", {
  ...
  <tr>
    <th scope="col">#</th>
    <th scope="col">Felino</th>
    <th scope="col">Descripcion</th>
    <th scope="col">Imagen</th>
  </tr>
  </thead>
  <tbody>
    <tr v-for="felino in felinos" >
      <td>{{felino.id}}</td>
      <td>{{felino.title}}</td> 
      <td>{{felino.description}}</td> 
      <td> <img :src="felino.imgUrl" class="img-thumbnail img-cropped"> </td> 
    </tr>
  </tbody>
  </table>
  `,
